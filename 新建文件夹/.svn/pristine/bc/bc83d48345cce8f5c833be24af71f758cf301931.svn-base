...
return array(
//网站路径
'web_path' => 'http://sxtyzw.duapp.com/',
//Session配置
...
'cookie_pre' => 'VixYD_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://sxtyzw.duapp.com/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://sxtyzw.duapp.com/statics/js/', //CDN JS
'css_path' => 'http://sxtyzw.duapp.com/statics/css/', //CDN CSS
'img_path' => 'http://sxtyzw.duapp.com/statics/images/', //CDN img
'app_path' => 'http://sxtyzw.duapp.com/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'v5R8MvKx0uYu55aisAiO', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'sxtyzw.duapp.com/phpsso_server',	//接口地址
'phpsso_auth_key' => '2ZNytDYFLTQdWKQKohmxgIvr8lYI2GGO', //加密密钥
