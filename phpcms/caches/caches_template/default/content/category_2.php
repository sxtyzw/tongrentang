...
<div class="shen">
    ...
    <div class="shen2">
        ...
        <div class="shen23">
            <div class="shen231"><?php echo $CATEGORYS['28']['catname'];?></div>
            <div class="shen232">
                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=2cf607f40788c78053a32265cdc25d31&action=lists&catid=28&num=3&order=listorder+ASC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>'28','order'=>'listorder ASC','limit'=>'3',));}?>
                <?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
                ...
                <div class="shen2222">
                    ...
                    <div><?php echo str_cut($r[description],200);?></div>
                    <a href="<?php echo $r['url'];?>"> <div class="shen22223">更多></div></a>
                </div>
                <?php $n++;}unset($n); ?>
                <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
            </div>
